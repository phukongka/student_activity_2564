                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li>กิจกรรมโฮมรูม</li>
            							<li class="active">รายชื่อแจ้งผู้ปกครอง</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                 <h5>แจ้งผู้ปกครอง กิจกรรมโฮมรูม สัปดาห์ที่.<?php echo $_SESSION["week1"]  ?>.. สาขาวิชา...<?php echo $row1['major_name']?> อาจารย์ที่ปรึกษา  <?php echo $row['user_name'];?></h5>
                                                </div>
                                            </div>  
