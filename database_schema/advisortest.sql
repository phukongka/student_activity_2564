...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2021 at 10:15 AM
...
CREATE TABLE `general_user` (
  ...
  `user_pic` varchar(20) COLLATE utf8_thai_520_w2 DEFAULT NULL COMMENT 'ชื่อภาพผู้ใช้งานระบบ',
  `signature_id` int(10) DEFAULT NULL COMMENT 'รหัสภาพลายเซนต์',
  `group_id` varchar(11) COLLATE utf8_thai_520_w2 NOT NULL COMMENT 'รหัสกลุ่มเรียน',
...
INSERT INTO `general_user` (`user_id`, `prefix`, `user_name`, `user_lastname`, `user_position`, `technical_position`, `position_level`, `academic_position`, `user_email`, `user_pass`, `major_code`, `minor_id`, `user_pic`, `signature_id`, `group_id`, `user_tel`, `view_id`) VALUES
('1349900045616', 'นาย', 'วชิรบดินทร์', 'ศุภธีรารักษ์', 'ครู', 'ไม่มี', 'คศ. 1', 'ผู้ช่วยหัวหน้างานศูนย์ข้อมูล', 'homeworkmacka@gmail.com', 'holyfire', '3901', NULL, NULL, NULL, '632090102', '0866525611', 'lv01'),
('Alongkorn_Phukongka', 'นาย', 'อลงกรณ์', 'ภูคงคา', 'ครู', 'ครูชำนาญการพิเศษ', 'คศ. 3', 'หัวหน้างานศูนย์ข้อมูล', 'phukongka@ccollege.ac.th', '123456', '3901', NULL, NULL, NULL, '62390105', '0811111111', 'lv01');
