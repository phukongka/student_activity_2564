<?php
  ...
  if($obe_detail_txt == "") {
    ...
    $sql = "INSERT INTO home_obedience_topic VALUES ('', '".$obe_detail_txt."', NOW(), '".$_SESSION['user_id']."', '".$_SESSION['week']."', '".$question_txt."');";
  ...
  $obe_id_sql = "SELECT home_obedience_topic.obe_id FROM home_obedience_topic WHERE home_obedience_topic.user_id = '".$_SESSION['user_id']."' AND home_obedience_topic.obe_week = '".$_SESSION['week']."' ;";
